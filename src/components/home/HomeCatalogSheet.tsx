...
import type { HomeCatalogItem } from '@/data/home';
...
export function HomeCatalogSheet({ open, title, items, onClose, onPick }: Props) {
            ...
            {items.map((item) => (
              <Pressable
                ...
                <View style={[styles.mark, { backgroundColor: colors.well }]}>
                  <HomeGlyph kind={item.glyph} size={18} color={colors.accent} />
                </View>
